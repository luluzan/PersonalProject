...
<template>
  <main>
    <!-- <div class="moon">
      <img src="src/assets/img/logoalphaNico.png" alt="logo">
    </div> -->
...
<center>  
  ...
  <table>  
    ...
    <br><br>
    <tr>
        <a class="small" href="/Ace_Monkey_Ilium/" target="_blank">
        Options...
        </a>
      <a style="opacity:0" >2</a>
        <a class="small" href="https://youtube.com/c/acemonkeyilium" target="_blank">
        Quit Game
        </a>
    </tr>
  </table>  
  <div class="subtitle" id="quote">Notch Notch Notch Notch Notch Notch!</div>
</center>
</body>  
  </main>
</template>
...
body {
  background: url("http://www.lb-stuff.com/Minecraft/AwesomeView.png") no-repeat center fixed;
